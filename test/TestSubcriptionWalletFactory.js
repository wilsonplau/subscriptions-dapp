...
contract('SubscriptionWalletFactory', async (accounts) =>  {
  ...
  */
  ...
  /**
    ...
    * Important that the owner of the SubscriptionManager contract is the person who called the createSubscriptionWallet function and not the factory contract
